...
const updateCropSchema = Joi.object({
  ...
  pricePerUnit: Joi.number().positive().optional(), // Alias for pricePerKg
  ...
  status: Joi.string().valid('active', 'sold', 'expired', 'draft', 'suspended').optional(),
  ...
  pesticides: Joi.boolean().optional(),
});
