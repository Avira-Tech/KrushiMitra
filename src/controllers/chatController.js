...
/**
 * Get active trade context (offer or contract) for a conversation
...
const getChatContext = async (req, res) => {
  try {
    ...
    // 2. Check for latest Pending Offer
    ...
    return res.status(500).json({ success: false, error: 'Failed to get chat context' });
  }
};

/**
 * Mark all messages in a conversation as read for current user
 * POST /api/v1/chats/conversations/:id/read
 */
