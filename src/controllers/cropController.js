...
//         .populate('farmer', 'name phone email location avatar rating username')
//         .skip(parseInt(skip))
...
// //       .populate('farmer', 'name phone email location username')
// //       .sort({ createdAt: -1 })
// //       .skip(parseInt(skip))
// //       .limit(parseInt(limit));
...
//           sanitizedUpdates.quantityUnit = sanitizer.sanitizeString(updates[field]);
...
//         } else if (field === 'qualityDetails' && typeof updates[field] === 'object') {
//           sanitizedUpdates.qualityDetails = {
//             moisture: updates[field].moisture,
//             protein: updates[field].protein,
//             foreignMatter: updates[field].foreignMatter,
//             description: sanitizer.sanitizeString(updates[field].description || ''),
//           };
//         } else {
