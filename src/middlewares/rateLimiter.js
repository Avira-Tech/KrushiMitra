...
// AI Prediction rate limiter (stricter as it might be expensive)
const aiLimiter = createLimiter({
  windowMs: 60 * 60 * 1000, // 1 hour
  max: 20,
  message: 'Daily AI prediction limit reached. Please try again tomorrow.',
  prefix: 'ai',
});

module.exports = { apiLimiter, authLimiter, otpLimiter, uploadLimiter, checkLimiter, aiLimiter };
