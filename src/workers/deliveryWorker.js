    ...
    async (job) => {
      ...
      if (deliveryResult.success) {
        await Contract.findByIdAndUpdate(contract._id, {
          ...
          'transport.driverName': deliveryResult.driverName,
          'transport.driverPhone': deliveryResult.driverPhone,
          'transport.vehicleNumber': deliveryResult.vehicleNumber,
          'transport.vehicleType': deliveryResult.vehicleType,
        });
